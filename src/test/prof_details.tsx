...
type ProfileNavigationProp = NativeStackNavigationProp<MainStackParamList, 'ProfileDetails'>
		...
		const fetchProfile = async () => {
			try {
				...
				if (data) {
					...
					// If profile is already complete and we're not in edit mode, redirect to MainTabs
	...
	const handleSubmit = async () => {
		...
		try {
			...
			if (params && params.returnScreen) {
				...
				// Default navigation to MainTabs
				Alert.alert("Success", "Profile updated successfully!", [
					{
						text: "Continue",
						onPress: () => navigation.navigate("MainTabs", { screen: "Home" })
