			...
			try {
				...
				if (data) {
					...
					if (complete && !editMode) {
						setTimeout(() => {
							navigation.replace("Home") // Replaced router.push with navigation.replace
						}, 1000)
					}
				} else {
		...
		try {
			...
			if (params && params.returnScreen) {
				Alert.alert("Success", "Profile updated successfully!", [
					{
						text: "Continue",
						onPress: () => navigation.navigate("VolunteerProfile") // Replaced router.push with navigation.navigate
					}
				])
			} else {
				...
				Alert.alert("Success", "Profile updated successfully!", [
					{
						text: "Continue",
						onPress: () => navigation.navigate("Home") // Replaced router.push with navigation.navigate
					}
				])
			}
		} catch (e: any) {
