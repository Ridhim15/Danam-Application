...
// Name the component and use VolunteerProfile as the screen name in props type
export default function VolunteerProfileScreen({ navigation }: NativeStackScreenProps<MainStackParamList, "VolunteerProfile">) {
                    ...
                    <View style={styles.profileCardContent}>
                        ...
                        <View style={styles.profileDetails}>
                            ...
                            <TouchableOpacity 
                                ...
                                onPress={() => router.push("/prof_details?isEditMode=true&returnScreen=VolunteerProfile&userRole=Volunteer")}
                            >
